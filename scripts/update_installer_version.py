...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ChannelStrip Demo Installer\n"
      else:
        line="OutputBaseFilename=ChannelStrip Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ChannelStrip Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ChannelStrip installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ChannelStrip Demo installer\n"
     else:
       line="SetupWindowTitle=ChannelStrip installer\n"
