...
def main():
  ...
  plistpath = scriptpath + "/resources/ChannelStrip-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChannelStrip-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/ChannelStrip-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ChannelStrip-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ChannelStrip-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/ChannelStrip.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/ChannelStrip.iss",inplace=1):
